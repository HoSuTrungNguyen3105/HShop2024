        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Xu = table.Column<int>(type: "int", nullable: true, defaultValue: 0),
                    ...
                    ThoiGianDangKy = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFantastic = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__LoginHis__3214EC07CE316663", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoginHistory_NhanVien",
                        column: x => x.MaNv,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Voucher__3214EC0791E65616", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Voucher_HangHoa",
                        column: x => x.MaHH,
                        principalTable: "HangHoa",
                        principalColumn: "MaHH");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Voucher_MaHH",
                table: "Voucher",
                column: "MaHH");

            migrationBuilder.CreateIndex(
                name: "UQ__Voucher__A25C5AA76CEC4E53",
                table: "Voucher",
                column: "Code",
                unique: true);
